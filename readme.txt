...
Installing "opengrants" can be done either by searching for "opengrants" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
